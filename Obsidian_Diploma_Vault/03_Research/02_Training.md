...
The custom PyTorch branch is experimental. Do not claim final custom-model biometric accuracy without valid training logs and labeled verification results.
